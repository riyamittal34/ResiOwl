...
public class ReOpenAccount extends JFrame {
...
//	}
	...
	public ReOpenAccount() {
		...
		JLabel lblCloseAccount = new JLabel("ReOpen Account");
		...
		JButton btnClose = new JButton("ReOpen Account");
		btnClose.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{
					JOptionPane.showMessageDialog(ReOpenAccount.this, "Please fill all the fields!!", "Error", JOptionPane.ERROR_MESSAGE);
				}
				else
				{
					try
					...
					if(i==1)
					{
						...
						if(j==1)
						{
							JOptionPane.showMessageDialog(ReOpenAccount.this, "Account is ReOpened", "Sucessful", JOptionPane.INFORMATION_MESSAGE);
							dispose();
						}
						else
						{
							JOptionPane.showMessageDialog(ReOpenAccount.this, "Account ReOpening Failed!!", "Error", JOptionPane.ERROR_MESSAGE);
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
									.addComponent(btnClose, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
