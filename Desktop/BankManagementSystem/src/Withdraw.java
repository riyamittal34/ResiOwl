...
//	}
	...
	public Withdraw() {
		...
		JLabel lblDeposit = new JLabel("Withdraw Money");
		...
		btnDeposit.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				{
					JOptionPane.showMessageDialog(Withdraw.this, "Please fill all the fields!!", "Error", JOptionPane.ERROR_MESSAGE);
				}
				else
				{	
					...
					if(i==1)
					{
						...
						if(j==1)
						{
							...
							if(k==1)
							{
								...
								if(l==1)
								{
									JOptionPane.showMessageDialog(Withdraw.this, "Withdraw Completed", "Successful", JOptionPane.INFORMATION_MESSAGE);
					...
					{
						JOptionPane.showMessageDialog(Withdraw.this, "Withdraw Failed", "Error", JOptionPane.ERROR_MESSAGE);
						dispose();
					}
				}
